...
To enable GitHub integration in Cursor (create repos, push files, manage issues, etc.) without Docker:
...
3. Replace `YOUR_GITHUB_PAT` in `.cursor/mcp.json` with your token
4. Restart Cursor

The `mcp.json` file is gitignored to prevent committing tokens.
